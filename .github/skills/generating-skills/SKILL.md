...
description: Generates high-quality .agent/skills/ directories based on user requirements. Use when the user asks to "create a skill", "build a skill", or formalize a set of instructions into a system skill.
---
...
- The user provides a prompt or instructions and wants to save it as a reusable skill.
- The user asks for a structural template for a new skill.
